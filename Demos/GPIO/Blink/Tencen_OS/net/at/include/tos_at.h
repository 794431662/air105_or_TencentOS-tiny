...
#define AT_DATA_CHANNEL_FIFO_BUFFER_DEFAULT_SIZE    (1500 + 500)

#define AT_UART_RX_FIFO_BUFFER_SIZE                 (1500 + 500)  



#define AT_RECV_CACHE_SIZE                          1500

#define AT_CMD_BUFFER_SIZE                          512

#define AT_PARSER_TASK_STACK_SIZE                   600
